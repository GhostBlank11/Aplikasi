...
class Config {
  ...
  /// Generated by SiteNative 04-02-2023 03:38:46
  /// App UID: bb1f2a53-fbff-a58d-4cf5-ab493b34517b
  /// Version: https://convert.serverku.tech/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "Servku Technology";
  // App link
  ...
  // Signing
  static String osSigning = "6a056cb8b31a98434efe34f16c4b401a4e0ac7c5121e15ec3e91b9d005529c65";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "Tes",icon: "albums-outline.svg",type: ActionType.internal,value: "https://servku.my.id",),
